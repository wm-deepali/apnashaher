...
.summary-blue { border-color: #93c5fd; background: #eff6ff; }
.summary-green { border-color: #86efac; background: #f0fdf4; }
.summary-yellow { border-color: #fde68a; background: #fffbeb; }
.summary-pink { border-color: #f9a8d4; background: #fdf2f8; }
