    ...
    <div class="app-content content container-fluid">
        ...
        <div class="breadcrumbs-top d-flex align-items-center bg-light mb-3">
            ...
            <div class="ml-auto mr-2">
                <a href="{{ route('admin.manage-packages.create') }}" class="btn btn-primary">
                            ...
                            <tbody>
                                @foreach($packages as $package)
                                    <tr>
                                        ...
                                        <td>
                                            @if($package->features)
                                                <ul style="padding-left: 0; list-style: none;">
                                                    ...
                                                    <li>
                                                        <span
                                                            style="color:blue;">{{ ucfirst($package->features->search_visibility) }}</span>
                                                        - Search Visibility
                                                    </li>
                                                    <!-- <li>
                                                    ...
                                                    <li>
                                                        <span
                                                            style="color:blue;">{{ ucfirst(str_replace('_', ' ', $package->features->profile_editing)) }}</span>
                                                        - Profile Editing
                                                    </li>
                                                    <li>
                                                        <span
                                                            style="color:blue;">{{ ucfirst(str_replace('_', ' ', $package->features->support_type)) }}</span>
                                                    </li>
                                                    <li>
                                                        <span
                                                            style="color:blue;">{{ $package->features->courses_programs ? "Upto " . $package->features->courses_programs : "No" }}</span>
                                                        - Courses/Programs
                                                    </li>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.manage-packages.edit', $package->id) }}"
                                                class="btn btn-primary btn-sm">Edit</a>

                                            <form action="{{ route('admin.manage-packages.destroy', $package->id) }}"
