...
Route::post('/verify-otp',[OtpController::class,'verifyOtp'])->name('verify-otp');
 ...
 Route::get('/institutes/check-whatsapp-mobile', function (Illuminate\Http\Request $request) {
    return \App\Models\Institute::where('mobile', $request->mobile)->exists();
});
...
Route::group(['prefix' => 'admin', 'middleware' => ['web','auth']], function () {
    ...
    Route::post('manage-institute/{id}/approve',
    [ManageInstituteController::class,'approve'])
    ->name('admin.manage-institute.approve');   

    Route::post('manage-institute/{id}/approve-review',
    ...
    Route::get('manage-institute/timing/{id}/edit',[ManageInstituteController::class,'editTiming'])->name('admin.manage-institute.timing.edit');
    Route::post('manage-institute/timing/update/{id}',[ManageInstituteController::class,'updateTiming'])->name('admin.manage-institute.timing.update');
    Route::delete('manage-institute/timing/{id}',[ManageInstituteController::class,'destroyTiming'])->name('admin.manage-institute.timing.destroy');
    ...
    Route::post('manage-institute', [ManageInstituteController::class, 'storeFullForm'])->name('admin.institutes-full.store');
     Route::post('/institutes-full/store', [ManageInstituteController::class, 'store'])
        ->name('admin.institutes-full.store');

    Route::get('/institutes-full/{id}/edit', [ManageInstituteController::class, 'edit'])
        ->name('admin.institutes-full.edit');

    Route::put('/institutes-full/{id}', [ManageInstituteController::class, 'update'])
        ->name('admin.institutes-full.update');
