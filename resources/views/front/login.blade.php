      ...
      <form class="login-form" id="otpLoginForm">
        ...
        <div class="form-group">
          ...
          <div class="phone-input-group">
            ...
            <input type="tel" class="form-input mobile-input" id="mobileNumber" placeholder="Enter 10-digit number"
              maxlength="10" pattern="[0-9]{10}" required autocomplete="tel">
          </div>
        </div>
        <div class="form-group">
          <p class="notfound" id="mobileNotFoundMsg" style="display:none;">Mobile Number entered does not exist, Please <a
              style="color:#1565c0;" href="{{route('list-your-institute')}}">click here</a> to List your Institute</p>
        </div>
        ...
        <div class="otp-container" id="otpContainer" style="display: none;">
          ...
          <div class="terms-checkbox">
            ...
            <label for="agreeTerms">
              I agree to the
              <a href="{{url('legal-policies/terms-and-condition')}}" target="_blank" class="terms-link">Terms &
                Conditions</a>
              and
    ...
    document.getElementById('sendOtpBtn')?.addEventListener('click', () => {
      ...
      fetch(sendurl, {
        ...
        .then(data => {
          ...
          } else if (data.status === 'incomplete') {   // 🔥 ADD THIS BLOCK
            toastr.warning(data.message);

            // redirect to listing with resume
            setTimeout(() => {
              window.location.href = data.redirect + '?resume=1&institute_id=' + data.institute_id;
            }, 1500);
