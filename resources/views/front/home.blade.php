...
<div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
  ...
  <div class="flex justify-center md:justify-end">
    ...
    <div class="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 xl:grid-cols-7 gap-3 md:gap-4">
      ...
      <!-- Category Card -->
      <div class="aspect-square bg-[#f0f4ff] hover:bg-[#e0e9ff] rounded-2xl p-3 md:p-5 text-center transition-all hover:shadow-md group cursor-pointer flex flex-col items-center justify-center">
        <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-white rounded-2xl flex items-center justify-center text-3xl md:text-4xl shadow-sm mb-3 md:mb-4 group-hover:scale-110 transition-transform">
          📚
        </div>
        <p class="font-semibold text-gray-800 text-[11px] md:text-sm leading-tight text-center" style="font-weight:700;">
          Board & Academic<br>Coachings
        </p>
      </div>

      <!-- Category 2 -->
      <div class="aspect-square bg-[#fff0f5] hover:bg-[#ffe4f0] rounded-2xl p-3 md:p-5 text-center transition-all hover:shadow-md group cursor-pointer flex flex-col items-center justify-center">
        <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-white rounded-2xl flex items-center justify-center text-3xl md:text-4xl shadow-sm mb-3 md:mb-4 group-hover:scale-110 transition-transform">
          🩺
        </div>
        <p class="font-semibold text-gray-800 text-[11px] md:text-sm leading-tight text-center" style="font-weight:700;">
          Medical & Engineering<br>Coachings
        </p>
      </div>

      <!-- Category 3 -->
      <div class="aspect-square bg-[#f0fdf4] hover:bg-[#d1f8e8] rounded-2xl p-3 md:p-5 text-center transition-all hover:shadow-md group cursor-pointer flex flex-col items-center justify-center">
        <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-white rounded-2xl flex items-center justify-center text-3xl md:text-4xl shadow-sm mb-3 md:mb-4 group-hover:scale-110 transition-transform">
          🏆
        </div>
        <p class="font-semibold text-gray-800 text-[11px] md:text-sm leading-tight text-center" style="font-weight:700;">
          Competitive Exam<br>Coachings
        </p>
      </div>

      <!-- Category 4 -->
      <div class="aspect-square bg-[#fef3e8] hover:bg-[#fde8d3] rounded-2xl p-3 md:p-5 text-center transition-all hover:shadow-md group cursor-pointer flex flex-col items-center justify-center">
        <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-white rounded-2xl flex items-center justify-center text-3xl md:text-4xl shadow-sm mb-3 md:mb-4 group-hover:scale-110 transition-transform">
          💼
        </div>
        <p class="font-semibold text-gray-800 text-[11px] md:text-sm leading-tight text-center" style="font-weight:700;">
          Commerce & Professional<br>Coachings
        </p>
      </div>

      <!-- Category 5 -->
      <div class="aspect-square bg-[#f3e8ff] hover:bg-[#e9d5ff] rounded-2xl p-3 md:p-5 text-center transition-all hover:shadow-md group cursor-pointer flex flex-col items-center justify-center">
        <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-white rounded-2xl flex items-center justify-center text-3xl md:text-4xl shadow-sm mb-3 md:mb-4 group-hover:scale-110 transition-transform">
          💻
        </div>
        <p class="font-semibold text-gray-800 text-[11px] md:text-sm leading-tight text-center" style="font-weight:700;">
          Computer & IT<br>Training
        </p>
      </div>

      <!-- Category 6 -->
      <div class="aspect-square bg-[#ecfdf5] hover:bg-[#c6f6e0] rounded-2xl p-3 md:p-5 text-center transition-all hover:shadow-md group cursor-pointer flex flex-col items-center justify-center">
        <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-white rounded-2xl flex items-center justify-center text-3xl md:text-4xl shadow-sm mb-3 md:mb-4 group-hover:scale-110 transition-transform">
          🗣️
        </div>
        <p class="font-semibold text-gray-800 text-[11px] md:text-sm leading-tight text-center" style="font-weight:700;">
          Language & Skill<br>Development
        </p>
      </div>

      <!-- Category 7 -->
      <div class="aspect-square bg-[#fefce8] hover:bg-[#fef9c3] rounded-2xl p-3 md:p-5 text-center transition-all hover:shadow-md group cursor-pointer flex flex-col items-center justify-center">
        <div class="w-10 h-10 md:w-12 md:h-12 mx-auto bg-white rounded-2xl flex items-center justify-center text-3xl md:text-4xl shadow-sm mb-3 md:mb-4 group-hover:scale-110 transition-transform">
          🛠️
        </div>
        <p class="font-semibold text-gray-800 text-[11px] md:text-sm leading-tight text-center" style="font-weight:700;">
          Vocational & Career<br>Skill
        </p>
      </div>
...
<!--  <p class="text-gray-500 text-base md:text-lg mt-2 max-w-2xl mx-auto">-->
...
<!--    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">-->
      ...
      <!-- CARD -->
<!--      <div class="border rounded-xl p-4 hover:shadow-lg transition bg-white">-->

        <!-- Tag -->
<!--        <span class="text-xs bg-yellow-100 text-yellow-700 px-2 py-1 rounded-full">Featured</span>-->
...
<!--          Best coaching for commerce, CA & CS preparation with expert faculty.-->
<!--        </p>-->
...
<!--          <button class="w-full bg-blue-600 text-white py-2 rounded-lg">Call Now</button>-->
<!--          <button class="w-full border border-blue-600 text-blue-600 py-2 rounded-lg">WhatsApp</button>-->
<!--        </div>-->
...
<!--        <span class="text-xs bg-red-100 text-red-600 px-2 py-1 rounded-full">Popular</span>-->
...
<!--          Top UPSC coaching institute with high success rate.-->
<!--        </p>-->
...
<!--        <p class="text-gray-500 text-sm text-center mt-2">-->
<!--          Affordable SSC coaching with experienced mentors.-->
<!--        </p>-->
...
<section class="frustration-section">
  <div class="frustration-container">
    ...
    <div class="intro-paragraph">
      Finding genuine students or trustworthy institutes has become confusing, expensive, and unreliable on most platforms.<br><span style="color:blue;">ApnaShaher</span> brings back simplicity, trust, and local relevance.
    ...
    <div class="swiper testimonialSlider px-4 py-4">
      <div class="swiper-wrapper testimonial-slider-update">
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group h-full flex flex-col">
            <div class="flex items-center gap-4 mb-6">
              <img src="https://ashtonwell.com/public/assets/images/adnanahmed.avif" alt="Adnan Ahmed" class="w-16 h-16 rounded-full object-cover ring-4 ring-blue-100">
              <div>
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group h-full flex flex-col">
            <div class="flex items-center gap-4 mb-6">
              <img src="https://ashtonwell.com/public/assets/images/sumitkumar.jpg" alt="Sumit Kumar" class="w-16 h-16 rounded-full object-cover ring-4 ring-blue-100">
              <div>
            ...
            <div class="flex gap-1 mb-5">
              <i class="fas fa-star text-yellow-500 text-xl"></i><i class="fas fa-star text-yellow-500 text-xl"></i><i class="fas fa-star text-yellow-500 text-xl"></i><i class="fas fa-star text-yellow-500 text-xl"></i><i class="fas fa-star text-yellow-500 text-xl"></i>
            </div>
            <p class="text-gray-700 italic leading-relaxed flex-grow">
              "The Web Mingo team helped us build a robust online education system that’s easy to manage and fast. we love the platform’s speed and design. Highly recommended!"
            </p>
            <div class="mt-6 text-blue-200 text-6xl opacity-30">
              <i class="fas fa-quote-right"></i>
            </div>
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group h-full flex flex-col">
            <div class="flex items-center gap-4 mb-6">
              <img src="https://randomuser.me/api/portraits/men/45.jpg" alt="Andy Cox" class="w-16 h-16 rounded-full object-cover ring-4 ring-blue-100">
              <div>
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group h-full flex flex-col">
            <div class="flex items-center gap-4 mb-6">
              <img src="https://randomuser.me/api/portraits/men/33.jpg" alt="Mohd Rais" class="w-16 h-16 rounded-full object-cover ring-4 ring-blue-100">
              <div>
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group h-full flex flex-col">
            <div class="flex items-center gap-4 mb-6">
              <img src="https://ashtonwell.com/public/assets/images/rajesh-prasad.jpeg" alt="Rajesh Prasad" class="w-16 h-16 rounded-full object-cover ring-4 ring-blue-100">
              <div>
            ...
            <p class="text-gray-700 italic leading-relaxed flex-grow">
              "They built a complete website for our college that’s informative, modern, and easy for students to use. The team was professional and supportive throughout."
            </p>
            <div class="mt-6 text-blue-200 text-6xl opacity-30">
              <i class="fas fa-quote-right"></i>
            </div>
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group h-full flex flex-col">
            <div class="flex items-center gap-4 mb-6">
              <img src="https://ashtonwell.com/public/assets/images/mohd-umar.jpeg" alt="Mohd Umar" class="w-16 h-16 rounded-full object-cover ring-4 ring-blue-100">
              <div>
            ...
            <p class="text-gray-700 italic leading-relaxed flex-grow">
              "ApnaShaher looks promising for local visibility. The idea of category-based listing and direct enquiry is very useful for institutes."
            </p>
            <div class="mt-6 text-blue-200 text-6xl opacity-30">
              <i class="fas fa-quote-right"></i>
            </div>
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group h-full flex flex-col">
            <div class="flex items-center gap-4 mb-6">
              <img src="https://randomuser.me/api/portraits/women/39.jpg" alt="Ms Sheefali Nag" class="w-16 h-16 rounded-full object-cover ring-4 ring-blue-100">
              <div>
        ...
        <div class="swiper-slide">
          <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 group h-full flex flex-col">
            <div class="flex items-center gap-4 mb-6">
              <img src="https://ashtonwell.com/public/assets/images/pratibhasachan.jpg1" alt="Mr. Vineet Kumar" class="w-16 h-16 rounded-full object-cover ring-4 ring-blue-100">
              <div>
