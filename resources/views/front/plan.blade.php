...
@php
    $seo = getSeo('price-plans');
@endphp

@section('meta_title', $seo->meta_title ?? 'Price & Plans')
...
@endif
    ...
    <script>
        function choosePlan(planId) {
            ...
            let isLoggedIn = {{ auth('institute')->check() ? 'true' : 'false' }};
            ...
            fetch('/upgrade-plan', {
                ...
                .then(data => {
                    ...
                    // STEP 2: call EXISTING payment API (same as listing)
                    fetch('/create-payment', {
                        ...
                        .then(payment => {
                            ...
                            if (payment.type === 'free') {
                                window.location.href = '/free-plan-complete?institute_id=' + data.institute_id;
                                return;
                            }
