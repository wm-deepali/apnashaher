...
.admission-enquiry-btn:hover {
  ...
  .institute-profile-section {
    ...
    .institute-name { font-size: 26px; line-height:30px;}
    .info-table { grid-template-columns: 1fr; gap: 12px; }
...
<style>
  ...
  /* Pastel Variations */
  .pastel-blue { border-top: 6px solid #bbdefb; }
  .pastel-green { border-top: 6px solid #c8e6c9; }
  .pastel-purple { border-top: 6px solid #e1bee7; }
  .pastel-orange { border-top: 6px solid #ffe0b2; }
    ...
    <div class="profile-container">
      ...
      <div class="profile-header">
        ...
        <div class="institute-info">
          <h1 class="institute-name">{{$institute->name}} @if($verified)<i class="fas fa-check-circle verified-tick"></i>@endif </h1>
      ...
      <div class="info-table">
        ...
        <h6><b>Registered</b><br>2008</h6> -->
          ...
          <div class="profile-actions">
            ...
            <a href="https://wa.me/{{$institute->whatsapp}}" target="_blank" class="btn-whatsapp whatsapp-click-btn"  data-id="{{$institute->id}}">
...
<section class="institute-profile-section  ">
    ...
    @if($institute->logo)
        <div class="w-20 h-20 bg-white rounded  border-1 border-white overflow-hidden" style="border:1px solid #cdc8c8;">
          ...
          <div class="rating-section">
            ...
            <span class="mobile-view-div">||</span>
                    ...
                    <div class="bg-white border border-gray-100 rounded  flex items-center justify-between estblished">
                        <p class=" uppercase tracking-widest text-slate-500 font-medium "> Established - {{$institute->established_year ?? 'N/A'}}</p>
  ...
  <!--  </div>-->
                ...
                <div class="slideshow-container mb-8 rounded-2xl overflow-hidden shadow-lg" >
                    <div class="mySlides fade">
                        <img src="{{ asset('assets/slider/slider1.jpg') }}" alt="Slider 1" style="width:100%; height:100%; object-fit: cover;">
                    </div>
                    <div class="mySlides fade">
                        <img src="{{ asset('assets/slider/slider2.jpg') }}" alt="Slider 2" style="width:100%; height:100%; object-fit: cover;">
                    </div>
                    <div class="mySlides fade">
                        <img src="{{ asset('assets/slider/slider3.jpg') }}" alt="Slider 3" style="width:100%; height:100%; object-fit: cover;">
                    </div>
  ...
  <div class="modal-content">
    ...
    <div class="modal-footer">
      <button onclick="openLeftSidebar()" 
              class="admission-enquiry-btn w-full py-4 text-lg font-semibold">
    ...
    <form class="enquiry-form">
      ...
      <div class="form-group">
        ...
        <div class="en-phone-group phone-group">
          ...
          <input type="tel" id="en-mobile" class="form-input phone-input" placeholder="Enter 10-digit number" required><br>
          <button type="button" id="send-otp-btn" style="margin-left:10px;" class="en-mobile-btn">Send OTP</button>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <textarea class="form-textarea" id="en-message" rows="5" placeholder="Tell us what you want to know..."></textarea>
      </div>
  ...
  <div class="time-review-container">
    ...
    <div class="time-slots-card">
      ...
      <div class="time-slot">
          ...
          <div class="timing">{{date('g:i A', strtotime($timing->open_time))}} To {{date('g:i A', strtotime($timing->close_time))}}</div>
        </div>
      @else
      ...
      <form class="review-form" id="review-form">
        ...
        <div class="form-group">
          ...
          <div class="phone-group">
            ...
            <input type="tel"  name="mobile" id="mobile" class="form-input phone-input" placeholder="Enter mobile number" style="width: 75%;" required >
            </div>
 ...
 <!-- Other Form Fields -->
  ...
  <input type="hidden" id="institute_id" name="institute_id" value="{{ $institute->id }}">
        <div class="form-group">
          ...
          <textarea class="form-textarea" id="review" name="review" rows="5" placeholder="Share your experience, feedback or suggestions..." required></textarea>
        </div>
    ...
    @endif
            ...
            <div class="px-8 pb-8 space-y-3">
                <a href="tel:{{$institute->mobile}}" 
                   class="btn-contact w-full flex items-center justify-center gap-3 py-4 text-lg font-semibold rounded-2xl">
                ...
                <a href="https://wa.me/{{$institute->whatsapp}}" target="_blank" 
                   class="btn-whatsapp w-full flex items-center justify-center gap-3 py-4 text-lg font-semibold rounded-2xl">
                    <i class="fab fa-whatsapp"></i> 
                    WhatsApp Now
                </a>
                @endif
                <p class="" style="width:100%; display:flex; text-align:center;justify-content: center;">Member Since: 23/11/2026</p>
            </div>
...
<div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-2xl z-50 md:hidden" style="z-index:9999">
    <div class="flex items-center h-16 max-w-7xl mx-auto ">
        
        @if($institute->mobile)
        <a href="tel:{{$institute->mobile}}" 
           class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5  flex items-center justify-center gap-2 transition-all active:scale-95">
        ...
        @if($institute->whatsapp)
        <a href="https://wa.me/{{$institute->whatsapp}}" target="_blank" 
           class="flex-1 bg-[#25D366] hover:bg-[#20b058] text-white font-semibold py-3.5  flex items-center justify-center gap-2 transition-all active:scale-95">
        ...
        <a href="https://wa.me/{{$institute->whatsapp}}" target="_blank" 
           class="flex-1 bg-[#25D366] hover:bg-[#20b058] text-white font-semibold py-3.5  flex items-center justify-center gap-2 transition-all active:scale-95 w-full">
            <i class="fab fa-whatsapp text-xl"></i>
        ...
        <a href="tel:{{$institute->mobile}}" 
           class="flex-1 bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3.5  flex items-center justify-center gap-2 transition-all active:scale-95 w-full">
            <i class="fas fa-phone-alt text-lg"></i>
            <span>Call Now</span>
        </a>
        @endif
