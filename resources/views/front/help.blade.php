...
@php
  $seo = getSeo('institute-support');
@endphp

@section('meta_title', $seo->meta_title ?? 'Institute Support')
    ...
    <div class="help-container max-w-7xl mx-auto px-6">
      ...
      <div class="text-center mb-16">
        ...
        <p class="help-description text-lg text-gray-600 mt-4 max-w-4xl mx-auto">
          Need assistance? We offer comprehensive resources, FAQs, and contact information to address all your inquiries
          and technical issues. Get the help you need quickly and efficiently!
        </p>
      </div>
      ...
      <div class="help-cards-grid grid md:grid-cols-3 gap-8 lg:gap-10">
        ...
        <!-- Card 1: FAQ -->
        <div
          class="help-card bg-white rounded-2xl shadow-lg border border-blue-100 overflow-hidden hover:shadow-2xl hover:-translate-y-3 transition-all duration-300">
          ...
          <div class="help-card-body p-8 text-center">
            ...
            <a href="#"
              class="help-btn inline-block bg-blue-600 text-white px-10 py-4 rounded-xl font-semibold hover:bg-blue-700 transition">
              Click Here →
            </a>
          </div>
        </div>
        ...
        <div
          class="help-card bg-white rounded-2xl shadow-lg border border-orange-100 overflow-hidden hover:shadow-2xl hover:-translate-y-3 transition-all duration-300 relative">
          ...
          <div class="help-card-header bg-gradient-to-r from-orange-500 to-orange-600 text-white p-8 text-center">
            ...
            <p class="mt-3 text-orange-100">Do you still need support? No worries, create a ticket and we will help you
            </p>
          </div>
          <div class="help-card-body p-8 text-center">
            <p class="text-gray-600 mb-6">Our team will respond within 24 hours</p>
            <a href="#"
              class="help-btn inline-block bg-orange-600 text-white px-10 py-4 rounded-xl font-semibold hover:bg-orange-700 transition">
              Raise Ticket →
            </a>
          </div>
        </div>
        ...
        <div
          class="help-card bg-white rounded-2xl shadow-lg border border-purple-100 overflow-hidden hover:shadow-2xl hover:-translate-y-3 transition-all duration-300">
